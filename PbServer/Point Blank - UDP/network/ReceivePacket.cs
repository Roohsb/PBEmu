/*
 * Arquivo: ReceivePacket.cs
 * Código criado pela MoMz Games
 * Última data de modificação: 06/01/2017
...
namespace Battle.network
{
    public class ReceivePacket
    {
        ...
        protected internal byte[] getBuffer() => _buffer;
        protected internal int getOffset() => _offset;
        ...
        protected internal Half3 readUHVector() => new Half3(readUH(), readUH(), readUH());
        protected internal Half3 readTVector() => new Half3(readT(), readT(), readT());
