...
namespace Game.data.chat
{
    public static class UnBan
    {
        public static string UnbanByNick(string str, Account player) => 
            BaseUnbanNormal(player, AccountManager.GetAccount(str.Substring(4), 1, 0));
        public static string UnbanById(string str, Account player) =>
            BaseUnbanNormal(player, AccountManager.GetAccount(long.Parse(str.Substring(5)), 0));

        public static string SuperUnbanByNick(string str, Account player) =>
            BaseUnbanSuper(player, AccountManager.GetAccount(str.Substring(5), 1, 0));
